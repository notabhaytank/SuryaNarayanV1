...
import thumbnailtwo from "../assets/Thumbnail2.svg"
    ...
    return (
        ...
        >
            <div className="self-center w-[358px]  lg:w-[1200px] ">
                <div
                    className="items-start self-stretch p-10 gap-10 border-l-[color:var(--light-mode-stroke,#D7DDE4)] border-r-[color:var(--light-mode-stroke,#D7DDE4)] border-r  dark:border-x-[#3D3D3D] dark:bg-[#161616] bg-white flex grow flex-col w-full mx-auto pb-10 px-10 border-l border-solid max-lg:max-w-full max-lg:px-5"
                >
                    <div className="items-center flex w-[78px] max-w-full gap-2 self-start">
                        <div
                    ...
                    <div
                        className="self-stretch  dark:border-[#3D3D3D] border border-[color:var(--light-mode-stroke,#D7DDE4)] shadow-sm bg-[#F5F6F8] dark:bg-[#2B2B2B] flex w-full justify-between gap-5 lg:gap-10 lg:p-10 pl-10  pt-10 pb-4 rounded-[24px] border-solid max-md:max-w-full max-md:flex-wrap  max-md:pl-5"
                    >
                        <div className="items-stretch flex gap-0 max-md:max-w-full lg:mr-0 mr-5 max-md:flex-wrap">
                            <div
                                className="items-stretch flex gap-4 grow basis-[0%] flex-col max-md:max-w-full"
                            >
                                <div className="items-center flex w-[137px] max-w-full  self-start">
                                    <img
                                        loading="lazy"
                                ...
                                <div className="items-stretch flex w-40 max-w-full gap-1 self-start">
                                    <div
                                        className="text-[#575E68] dark:text-[#999] font-InterDisplay text-[12px]  font-semibold leading-5 whitespace-nowrap justify-center items-stretch  dark:border-[#3D3D3D] border-[1px] border-[color:var(--light-mode-stroke,#D7DDE4)] dark:bg-[#161616] bg-white grow px-3 py-2 rounded-[8px] border-solid"
                                    >
                                        Freelance
                                    </div>
                                    <div
                                        className="text-[#575E68] dark:text-[#999]  text-xs font-semibold leading-5 whitespace-nowrap justify-center items-stretch border  dark:border-[#3D3D3D] border-[color:var(--light-mode-stroke,#D7DDE4)] dark:bg-[#161616] bg-white grow px-3 py-2 rounded-[8px] border-solid"
                                    >
                                        Sep 2023
                                    </div>
                                </div>
                                <div className="items-stretch flex gap-2 flex-col max-md:max-w-full">
                                    <div
                                        className=" text-xl dark:text-white font-InterDisplay text-[24px] font-extrabold leading-8 max-md:max-w-full"
                                    >
                                        Designing a media kit platform
                                    </div>
                                    <div
                                        className="text-[#575E68] dark:text-[#999] text-[15px] leading-[23px]  max-md:max-w-full"
                                    >
                        ...
                        <img
                            ...
                            src={thumbnaild}
                            className=" h-[348px] hidden aspect-[1.6] -m-10 lg:place-self-start lg:flex  "
                        />
                    </div>
                    <div
                        className="self-stretch  dark:border-[#3D3D3D] border border-[color:var(--light-mode-stroke,#D7DDE4)] shadow-sm bg-[#F5F6F8] dark:bg-[#2B2B2B] flex w-full justify-between gap-5 lg:gap-10 lg:p-10 pl-10  pt-10 pb-4 rounded-[24px] border-solid max-md:max-w-full max-md:flex-wrap  max-md:pl-5"
                    ...
                    {/*<div*/}
                    {/*    className="self-stretch  dark:border-[#3D3D3D] border border-[color:var(--light-mode-stroke,#D7DDE4)] shadow-sm bg-[#F5F6F8] dark:bg-[#2B2B2B] flex w-full justify-between gap-5 mt-10 pl-10  pt-10 pb-4 rounded-[24px] border-solid max-md:max-w-full max-md:flex-wrap  max-md:pl-5"*/}
                    {/*>*/}
                    ...
                    {/*                <div*/}
                    {/*                    className="text-[#575E68] dark:text-[#999] text-xs font-semibold leading-5  dark:border-[#3D3D3D] whitespace-nowrap justify-center items-stretch border border-[color:var(--light-mode-stroke,#D7DDE4)] dark:bg-[#161616] bg-white grow px-3 py-2 rounded-[8] border-solid"*/}
                    {/*                >*/}
                    {/*                    Full Time*/}
                    {/*                </div>*/}
                    {/*                <div*/}
                    {/*                    className="text-[#575E68] dark:text-[#999] text-xs font-semibold leading-5 whitespace-nowrap justify-center items-stretch  dark:border-[#3D3D3D] border border-[color:var(--light-mode-stroke,#D7DDE4)] dark:bg-[#161616] bg-white grow px-3 py-2 rounded-[8px] border-solid"*/}
                    {/*                >*/}
                    {/*                    Nov 2022*/}
                    {/*                </div>*/}
                    {/*            </div>*/}
                    ...
                    {/*        src={thumbnaild}*/}
                    {/*        className=" h-[348px] hidden -m-10 lg: place-self-start lg:flex  "*/}
                    {/*    />*/}
                    {/*</div>*/}
                    ...
                    {/*<div*/}
                    {/*    className="self-stretch relative z-20  dark:border-[#3D3D3D] border border-[color:var(--light-mode-stroke,#D7DDE4)] shadow-sm bg-[#F5F6F8] dark:bg-[#2B2B2B] flex w-full justify-between gap-5 mt-10 lg:p-10  pt-10  rounded-[24px] border-solid max-md:max-w-full max-md:flex-wrap  "*/}
                    {/*>*/}
                    ...
                    {/*        src={mobiled}*/}
                    {/*        className=" rounded-b-[18px] relative md:flex hidden z-10 w-[324px]  "*/}
                    {/*    />*/}
