...
function Footers(props) {
    return (
        <div
            className="justify-center items-start self-stretch bg-[linear-gradient(135deg,#EDF0F4_0%,#FFF_50%,#FFF_100%)] flex w-full flex-col px-20 max-lg:max-w-full max-lg:px-5"
        >
            <div
